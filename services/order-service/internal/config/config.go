...
const (
	...
	defaultPaymentsConsumerGroup = "order-service-payments"
...
func Load() Config {
	return Config{
		...
		PaymentsConsumerGroup: getEnv("PAYMENTS_CONSUMER_GROUP", defaultPaymentsConsumerGroup),
